...
namespace david63\acpversioncheck;

use phpbb\extension\base;

class ext extends base
{
	const ACPVERSIONCHECK_VERSION = '2.1.0';
	...
	public function is_enableable()
 	{
		...
		if (!$is_enableable)
		{
			...
			{
				$this->container->get('language')->add_lang('ext_enable_error', 'david63/acpversioncheck');
			}
			else
			{
				$this->container->get('user')->add_lang_ext('david63/acpversioncheck', 'ext_enable_error');
			}
		}
